<!--
	Algoritma:
		1.start
		2.tampilkan form login yang memiliki aksi tugaspraktikum1_hasillogin.php dan menggunakan fungsi validasi javascript
		3.jika button submit diklik maka validasi akan melakukan cek terhadap inputan apabila salah satu kosong maka akan muncul pesan dan pemberian efek focus pada textfield username, apabila inputtan tidak kosong maka validasi akan melakukan cek apakah inputan merupakan huruf atau bukan dengan cara memanggil fungsi cekhuruf(huruf) apabila inputan bukan huruf maka akan muncul pesan, dan jika inputan sudah benar berupa huruf maka proses akan dilanjutkan file tugaspraktikum1_hasillogin.php
		4.tugaspraktikum1_hasillogin.php akan menyimpan hasil inputan pada variabel $Id dan $passwd
		5.tugaspraktikum1_hasillogin.php akan melakukan cek kondisi inputan berupa string atau bukan dengan fungsi is_string($Id) dan is_string($passwd)
		6.jika inputan berupa string maka tugaspraktikum1_hasillogin.php akan mencocokkan nilai $Id dengan $username dan $passwd dengan $password
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		...
		<script type="text/javascript" language="javascript">
			...
			function validasi(form){
				...
				if(Id === '' || passwd === ''){		//kondisi jika id atau passwd kosong
					...
					return true;					//perintah yang dilakakukan apabila inputan berupa huruf dan berlanjut ke tugaspraktikum1_hasillogin.php
				}
	...
	<body>
		<div class="login">
			<b><h1>Login</h1></b>
			<hr color="#0099FF" width="400px;" size="5px"/>
			<div id="input">
				<form action="tugaspraktikum1_hasillogin.php" name="login" method="post" onSubmit="return validasi(this)">	<!--form menggunakan aksi tugaspraktikum1_hasillogin.php dan validasi javascript saat perintah submit dilakukan dengan menggunakan metode POST -->
					Username<br />
