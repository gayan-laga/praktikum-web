...
Algoritma:
        1.start
        2.includekan file tugaspraktikum_proses.php
        3.cek username dan password dengan inputan(usser : admin || passw : admin)
        4.tapilkan login apabila session kosong atau tidak tersedia
        5.cek username dan password dengan inputan,jika cocok tampilkan file tugaspraktikum_index.php,jika tidak cocok tampilkan pemberintahuan
        6.lakukan langkah 2-5 sampai ketemu inputan yang cocok
        7.setelah cocok periksa isi session apabila berisi '' maka tampilkan tugaspraktikum_index.php kemudian hapus session
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
        <head>
                ...
                <style type="text/css">						
                        body{											<!--Pewarnaan dan pendisignan halaman web--> 
        ...
        <body>
                <?php
                        ...
                        require_once('./tugaspraktikum_proses.php');
